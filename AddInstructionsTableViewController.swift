...
class AddInstructionsTableViewController: UITableViewController {
    ...
    @IBAction func onAddNewInstruction(sender: UIButton) {
        globalInstruction.append(txtNewInstruction.text!)
        
        txtInstructionList.text = txtInstructionList.text + "\(globalInstruction.count)" + ". " + txtNewInstruction.text! + "\n"
    }
    ...
    override func viewDidLoad() {
        ...
        if(globalInstruction.count != 0){
            for i in 0...globalInstruction.count-1{
                txtInstructionList.text = txtInstructionList.text + globalInstruction[i] + "\n"
            }
        }
